...
You can scale services horizontally and tailor deployments - from a minimal _Things+Gateway+MongoDB_ setup to full
...
> _Figure: Eclipse Ditto in a scalable IoT deployment, connecting devices via MQTT and exposing twin APIs to
> applications_
